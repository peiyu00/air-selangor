...
import useMeterDemandTableData from "layouts/meterDemand/data/meterTableData";

function MeterDemandManagement() {
  const { tableData, openViewModal, selectedItem, handleCloseViewModal, openEditModal, handleCloseEditModal, setOpenEditModal, setTableData } = useMeterDemandTableData();
  ...
  const handleAddItem = async () => {
    try {
      const response = await axios.post("/demands", formData);
          ...
          <Grid item xs={12}>
            <Card>
              ...
              <Dialog open={openForm} onClose={handleToggleForm}>
                <DialogTitle>Add New Meter Demand</DialogTitle>
                <DialogContent>
                  <Grid container spacing={2}>
                    <Grid item xs={12}>
                      <TextField fullWidth label="Date" variant="outlined" name="Date" onChange={handleInputChange} />
                    </Grid>
                    <Grid item xs={12}>
                      <TextField fullWidth label="Faulty Program" variant="outlined" name="Faulty Program" onChange={handleInputChange} />
                    </Grid>
                    <Grid item xs={12}>
                      <TextField fullWidth label="Meter Complaint" variant="outlined" name="Meter Complaint" onChange={handleInputChange} />
                    </Grid>
                    <Grid item xs={12}>
                      <TextField fullWidth label="Meter Leak" variant="outlined" name="Meter Leak" onChange={handleInputChange} />
                    </Grid>
                  </Grid>
                </DialogContent>
                <DialogActions>
      ...
      <Dialog open={openViewModal} onClose={handleCloseViewModal}>
        ...
        {selectedItem && (
          <>
            ...
            <Typography>Faulty Program: {selectedItem.faultyProgram}</Typography>
            <Typography>Meter Complaint: {selectedItem.meterComplaint}</Typography>
            <Typography>Meter Leak: {selectedItem.meterLeak}</Typography>
          </>
        )}
      </DialogContent>
        ...
        <DialogContent>
          <Grid container spacing={2}>
            ...
            {initialSelectedItem && (
              <>
                <Grid item xs={12}>
                  <TextField fullWidth label="Date" variant="outlined" name="date" value={initialSelectedItem.date} onChange={handleInputChange} />
                </Grid>
                <Grid item xs={12}>
                  <TextField fullWidth label="Faulty Program" variant="outlined" name="faultyProgram" value={initialSelectedItem.faultyProgram} onChange={handleInputChange} />
                </Grid>
                <Grid item xs={12}>
                  <TextField fullWidth label="Meter Complaint" variant="outlined" name="meterComplaint" value={initialSelectedItem.meterComplaint} onChange={handleInputChange} />
                </Grid>
                <Grid item xs={12}>
                  <TextField fullWidth label="Meter Leak" variant="outlined" name="meterLeak" value={initialSelectedItem.meterLeak} onChange={handleInputChange} />
                </Grid>
              </>
            )}
          </Grid>
...
export default MeterDemandManagement;
